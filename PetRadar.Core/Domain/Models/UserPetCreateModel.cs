...
{
    public class UserPetCreateModel
    {
        ...
        [StringLength(100, MinimumLength = 1, ErrorMessage = "The field Name must be a string with a minimum length of {2} and a maximum length of {1}"), Required]
